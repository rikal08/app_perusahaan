...
<head>
    ...
    <title>PT Jaya Putra - Login</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"><img width="100%" src="img/bg.png"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
...
if (isset($_POST['login'])) {
    ...
    $cek_login = mysqli_query($koneksi,"SELECT * FROM user WHERE username='$username' AND password='$password'");
    $hasil=mysqli_num_rows($cek_login);
